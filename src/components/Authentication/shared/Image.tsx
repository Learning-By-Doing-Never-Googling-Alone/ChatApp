...
const Image = (): JSX.Element => {
  return (
    <div className="relative hidden   flex-1 lg:flex items-center justify-center w-full bg-cover bg-no-repeat bg-[url(https://i.ibb.co/98PdJGg/Server-Invite-Splash-Background.png)]   ">
